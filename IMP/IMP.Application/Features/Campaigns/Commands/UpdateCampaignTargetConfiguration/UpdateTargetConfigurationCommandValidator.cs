...
{
    public class UpdateTargetConfigurationCommandValidator : AbstractValidator<UpdateTargetConfigurationCommand>
    {
        public UpdateTargetConfigurationCommandValidator(IUnitOfWork unitOfWork)
        {
