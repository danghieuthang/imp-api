...
{
    public class GetSumaryMemberByCampaignIdQuery : IQuery<SumaryCampaignMemberViewModel>
    {
        public int CampaignId { get; set; }
        public class GetSumaryMemberByCampainIdQueryHandler : QueryHandler<GetSumaryMemberByCampaignIdQuery, SumaryCampaignMemberViewModel>
        {
            public GetSumaryMemberByCampainIdQueryHandler(IUnitOfWork unitOfWork, IMapper mapper) : base(unitOfWork, mapper)
            {
            }

            public override async Task<Response<SumaryCampaignMemberViewModel>> Handle(GetSumaryMemberByCampaignIdQuery request, CancellationToken cancellationToken)
            {
                ...
                var sumary = new SumaryCampaignMemberViewModel
                {
                ...
                return new Response<SumaryCampaignMemberViewModel>(sumary);
            }
        }
    }
}
