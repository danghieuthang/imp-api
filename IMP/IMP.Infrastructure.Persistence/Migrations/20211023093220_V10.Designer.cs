...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMP.Domain.Entities.Campaign", b =>
                {
                    ...
                    b.Property<DateTime?>("Announcing")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("Evaluating")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsPrizePerVoucher")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ReferralWebsite")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("IMP.Domain.Entities.CampaignCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IMP.Domain.Entities.CampaignCondition", b =>
                {
                    b.HasOne("IMP.Domain.Entities.Campaign", null)
                        .WithOne("CampaignCondition")
                        .HasForeignKey("IMP.Domain.Entities.CampaignCondition", "CampaignId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
